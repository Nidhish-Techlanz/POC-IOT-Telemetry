...
function SmokeDetector({ isSmokeDetected }) {
  ...
  const isConnected = isSmokeDetected != null;
          ...
          <div className="text-center mb-6">
            <div
              className={`text-3xl font-bold mb-2 ${
                isDetected ? "text-red-500" : "text-green-500"
              }`}
            >
            ...
            <div className="relative">
              ...
              {isDetected && (
                <div className="absolute -top-8 left-1/2 transform -translate-x-1/2">
                  ...
                  >
                    <path
                      d="M32 48c-4 0-8-2-10-6-2-4-1-8 1-11 2-3 5-5 8-6 3-1 6 0 9 2 3 2 5 5 6 8 1 3 0 6-2 9-2 3-5 4-8 4z"
                      fill="#6b7280"
                      opacity="0.6"
                    />
                    <path
                      d="M28 44c-3 0-6-1-8-4-2-3-2-6-1-9 1-3 3-5 6-6 3-1 5 0 7 1 2 1 4 3 5 6 1 2 0 5-1 7-1 2-3 4-6 5z"
                      fill="#9ca3af"
                      opacity="0.8"
                    />
                  </svg>
